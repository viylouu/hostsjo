...
when ODIN_OS == .Windows do foreign import alc "../OpenAL32.lib"
when ODIN_OS == .Darwin do foreign import alc "system:OpenAL.framework"
when ODIN_OS == .Linux do foreign import alc "system:libopenal.so"
